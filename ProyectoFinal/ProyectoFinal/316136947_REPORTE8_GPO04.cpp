...
int main()
{
    ...
    // Load models
    Model Base((char*)"Models/Chest/Base.obj");
    Model Superior((char*)"Models/Chest/Superior.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 1.0f, 1.0f, 1.0f);  //Color del objeto - Componente difusa
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mode)
{
    ...
    if (keys[GLFW_KEY_U]) //Adelante
    {
        //activanim = true;
        movelightPosZ += 0.1f;
    }

    if (keys[GLFW_KEY_J]) //Atras
    {
        //activanim = true;
        movelightPosZ -= 0.1f;
    }

    if (keys[GLFW_KEY_H]) //Izquierda
    {
        //activanim = true;
        movelightPosX -= 0.1f;
    }
    ...
    if (keys[GLFW_KEY_M]) //Arriba
    {
        //activanim = true;
        movelightPosY += 0.1f;
    }

    if (keys[GLFW_KEY_N]) //Abajo
    {
        //activanim = true;
        movelightPosY -= 0.1f;
    }
